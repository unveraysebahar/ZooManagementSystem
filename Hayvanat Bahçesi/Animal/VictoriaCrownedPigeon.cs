...
{
    public class VictoriaCrownedPigeon:Bird,IFly
    {
        public VictoriaCrownedPigeon(string breathingPattern, string formOfPoliferation, int wingwidth, int beaklength, string habitat, string modeofaction, string internalSkeletonStructure, string circulatorySystemType, string muscleType)
